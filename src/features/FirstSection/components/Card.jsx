export const Card = ({ icon, name, description }) => {
  return (
    <div className="flex flex-col bg-cardBg hover:bg-cardBgHover hover:shadow-lg rounded-lg p-[45px] cursor-default group">
      ...
      <p className="max-w-[200px] mb-[27px]  group-hover:text-white break-words">{description}</p>
      <a href="" className="mt-auto font-semibold text-cardLink group-hover:text-white">
        Learn more
      </a>
    </div>
  )
