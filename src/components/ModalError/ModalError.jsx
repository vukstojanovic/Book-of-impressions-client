...
export const ModalError = () => {
  ...
  return (
    <>
      ...
      ></div>
      <div className="fixed flex flex-col justify-between items-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center bg-[#04375b] text-white p-8 rounded-lg z-[102] w-10/12 max-w-md">
